...
Instance.prototype.hasMapping = function () {
  return this.mapping != null && (_.some(this.mapping.separationLeading) || _.some(this.mapping.separationWrapped));
};
...
Instance.prototype.transportCopy = Instance.prototype.updateDetails = function () {
  ...
  details.hasMapping = this.hasMapping();
  return details;
};
